...
def division_user(users, nodes):
    ...
    for i in range(len(users)):
        ...
        m.interest_points = nodes[index].points.copy()
        m.unfinished_points = nodes[index].points.copy()
